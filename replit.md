...
-   **Auto-Lotto Bot Risk Controls**: Advanced entry thresholds, confluence validation, post-loss cooldowns, tiered premium caps, and position sizing. Includes a "Pro Trader Checklist" for earnings, liquidity, and volume checks, and a DTE-Aware Smart Exit Strategy with tiered stop-loss logic and thesis revalidation. Integrates with Exit Intelligence for smart position management and Theta Protection System for DTE-based option filtering.
