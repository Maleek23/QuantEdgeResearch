...
>(({ className, variant = "default", ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      variant === "default" && "p-1 rounded-xl bg-card/60 border border-border/50",
      variant === "pills" && "gap-2",
      variant === "underline" && "border-b border-border/50 gap-0",
      className
    )}
    {...props}
  />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        variant === "default" && cn(
          "px-4 py-2 rounded-lg text-muted-foreground data-[state=active]:bg-gradient-to-r data-[state=active]:text-white",
          accentClasses[accentColor]
        ),
        variant === "pills" && cn(
          "px-4 py-2 rounded-full text-muted-foreground data-[state=active]:bg-gradient-to-r data-[state=active]:text-white",
          accentClasses[accentColor]
        ),
        variant === "underline" && cn(
          "px-4 py-3 text-muted-foreground border-b-2 border-transparent -mb-px data-[state=active]:text-white",
