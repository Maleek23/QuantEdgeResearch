      ...
      <main className="container mx-auto p-6 max-w-6xl space-y-8">
        <div className="space-y-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center shadow-lg shadow-cyan-500/20">
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-1 flex justify-center lg:justify-start">
                <div className="relative">
                  <img 
                    ...
                    className="w-48 h-48 rounded-lg object-cover border-2 border-cyan-500/20 shadow-lg"
              ...
              <div className="lg:col-span-2 space-y-6">
                <div>
                  <h2 className="text-xl font-semibold" data-testid="text-creator-name">Abdulmalik Ajisegiri</h2>
                  <p className="text-lg text-cyan-400 font-medium" data-testid="text-creator-title">Model Risk Engineer @ DTCC</p>
                ...
                <div className="space-y-4">
                  <div className="glass-subtle rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Education</h3>
                    </div>
                  ...
                  <div className="glass-subtle rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Certifications</h3>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="secondary" className="text-xs bg-slate-800/50 border-slate-700/50">CISA Certified</Badge>
                      <Badge variant="secondary" className="text-xs bg-slate-800/50 border-slate-700/50">MATLAB Certified</Badge>
                      <Badge variant="secondary" className="text-xs bg-slate-800/50 border-slate-700/50">Simulink Certified</Badge>
                    </div>
                  </div>
                  ...
                  <div className="glass-subtle rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Connect</h3>
                    </div>
                    <div className="flex gap-3">
                      <a 
                        ...
                        className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors hover-elevate px-2 py-1 rounded"
