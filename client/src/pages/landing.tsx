  ...
  const steps = [
    {
      ...
      description: "Explore market research briefs generated by our quantitative engine and AI analysis—or upload your own chart for instant pattern analysis.",
      icon: Activity
    },
    {
      number: "02",
      title: "Get Alerts",
      description: "Receive instant Discord notifications for new research briefs with key levels and risk parameters.",
      icon: Bell
    },
    {
      number: "03",
      title: "Track Patterns",
      description: "Every analysis is tracked for transparency. See historical accuracy and pattern outcomes over time.",
      icon: BarChart3
    }
  ];
            ...
            <Card data-testid="card-transparency-risk">
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                    Suggested stop zones for risk modeling
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <div className="max-w-2xl mx-auto">
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Pattern Tracking</h3>
                  <p className="text-muted-foreground mb-6">
              ...
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-sm">5 research briefs per day</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <Accordion type="single" collapsible className="space-y-3">
              ...
              <AccordionItem value="trading-styles" className="border rounded-xl px-6" data-testid="accordion-faq-styles">
                ...
                <AccordionContent className="text-muted-foreground pb-4" data-testid="content-faq-styles">
                  Yes! QuantEdge analyzes patterns for day trading, swing trading, and position trading timeframes. 
                  Each research brief includes timeframe context to help inform your own decisions.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="beginners" className="border rounded-xl px-6" data-testid="accordion-faq-beginners">
                ...
                <AccordionContent className="text-muted-foreground pb-4" data-testid="content-faq-beginners">
                  QuantEdge is designed as an educational research platform. Every research brief includes explainability features 
                  to help you understand the analysis. We recommend paper trading while learning.
                </AccordionContent>
              </AccordionItem>
